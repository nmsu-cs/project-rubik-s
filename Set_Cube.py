...
def start(self):    
    ...
    global  back0ID,  back1ID,  back2ID,  back3ID
    ...
    x = (self.set_input.winfo_screenwidth() - 300) // 6  # Center horizontally
    y = (self.set_input.winfo_screenheight() - 150) // 6  # Center vertically

    # Set Format the size and position of the window
    self.set_input.geometry("+{}+{}".format(x, y))
    ...
    # Pack all buttons
    self.upper0_button = tk.Button(self.set_input, bg="#DEDDDD", command=lambda:upper0_button_command(self.upper0_button,upper0_image))
    ...
    self.upper1_button = tk.Button(self.set_input, bg="#DEDDDD", command=lambda:upper1_button_command(self.upper1_button,upper1_image))
    ...
    self.upper2_button = tk.Button(self.set_input, bg="#DEDDDD", command=lambda:upper2_button_command(self.upper2_button,upper2_image))
    ...
    self.upper3_button = tk.Button(self.set_input, bg="#DEDDDD", command=lambda:upper3_button_command(self.upper3_button,upper3_image))
    ...
    self.down0_button = tk.Button(self.set_input, bg="#DEDDDD", command=lambda:down0_button_command(self.down0_button,down0_image))
    ...
    self.down1_button = tk.Button(self.set_input, bg="#DEDDDD", command=lambda:down1_button_command(self.down1_button,down1_image))
    ...
    self.down2_button = tk.Button(self.set_input, bg="#DEDDDD", command=lambda:down2_button_command(self.down2_button,down2_image))
    ...
    self.down3_button = tk.Button(self.set_input, bg="#DEDDDD", command=lambda:down3_button_command(self.down3_button,down3_image))
    ...
    self.front0_button = tk.Button(self.set_input, bg="#DEDDDD", command=lambda:front0_button_command(self.front0_button,front0_image))
    ...
    self.front1_button = tk.Button(self.set_input, bg="#DEDDDD", command=lambda:front1_button_command(self.front1_button,front1_image))
    ...
    self.front2_button = tk.Button(self.set_input, bg="#DEDDDD", command=lambda:front2_button_command(self.front2_button,front2_image))
    ...
    self.front3_button = tk.Button(self.set_input, bg="#DEDDDD", command=lambda:front3_button_command(self.front3_button,front3_image))
    ...
    self.back0_button = tk.Button(self.set_input, bg="#DEDDDD", command=lambda:back0_button_command(self.back0_button,back0_image))
    ...
    self.back1_button = tk.Button(self.set_input, bg="#DEDDDD", command=lambda:back1_button_command(self.back1_button,back1_image))
    ...
    self.back2_button = tk.Button(self.set_input, bg="#DEDDDD", command=lambda:back2_button_command(self.back2_button,back2_image))
    ...
    self.back3_button = tk.Button(self.set_input, bg="#DEDDDD", command=lambda:back3_button_command(self.back3_button,back3_image))
    ...
    self.left0_button = tk.Button(self.set_input, bg="#DEDDDD", command=lambda:left0_button_command(self.left0_button,left0_image))
    ...
    self.left1_button = tk.Button(self.set_input, bg="#DEDDDD", command=lambda:left1_button_command(self.left1_button,left1_image))
    ...
    self.left2_button = tk.Button(self.set_input, bg="#DEDDDD", command=lambda:left2_button_command(self.left2_button,left2_image))
    ...
    self.left3_button = tk.Button(self.set_input, bg="#DEDDDD", command=lambda:left3_button_command(self.left3_button,left3_image))
    ...
    self.right0_button = tk.Button(self.set_input, bg="#DEDDDD", command=lambda:right0_button_command(self.right0_button,right0_image))
    ...
    self.right1_button = tk.Button(self.set_input, bg="#DEDDDD", command=lambda:right1_button_command(self.right1_button,right1_image))
    ...
    self.right2_button = tk.Button(self.set_input, bg="#DEDDDD", command=lambda:right2_button_command(self.right2_button,right2_image))
    ...
    self.right3_button = tk.Button(self.set_input, bg="#DEDDDD", command=lambda:right3_button_command(self.right3_button,right3_image))
    ...
    self.submit_button = tk.Button(self.set_input,text="Submit",bg="gray",width = 5, command = lambda:submit_button_command(self))
