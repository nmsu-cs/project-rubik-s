...
def display0(self,upper,down,front,back,left,right):
    ...
    # Cube Background Sillhouette
    v0_background_cube_image = ImageTk.PhotoImage(Image.open(os.getcwd() + '/Assets/Display_Images/v0_cube_background.png'))
    ...
    ## Place images
    # Cube left face
    v0_left0_image = ImageTk.PhotoImage(Image.open(os.getcwd() + '/Assets/Display_Images/v0_' + 'left0_' + color_dict[left[0]] + '.png'))
    ...
    v0_left1_image = ImageTk.PhotoImage(Image.open(os.getcwd() + '/Assets/Display_Images/v0_' + 'left1_' + color_dict[left[1]] + '.png'))
    ...
    v0_left2_image = ImageTk.PhotoImage(Image.open(os.getcwd() + '/Assets/Display_Images/v0_' + 'left2_' + color_dict[left[2]] + '.png'))
    ...
    v0_left3_image = ImageTk.PhotoImage(Image.open(os.getcwd() + '/Assets/Display_Images/v0_' + 'left3_' + color_dict[left[3]] + '.png'))
    ...
    # Cube Upper Face
    v0_upper0_image = ImageTk.PhotoImage(Image.open(os.getcwd() + '/Assets/Display_Images/v0_' + 'upper0_' + color_dict[upper[0]] + '.png'))
    ...
    v0_upper1_image = ImageTk.PhotoImage(Image.open(os.getcwd() + '/Assets/Display_Images/v0_' + 'upper1_' + color_dict[upper[1]] + '.png'))
    ...
    v0_upper2_image = ImageTk.PhotoImage(Image.open(os.getcwd() + '/Assets/Display_Images/v0_' + 'upper2_' + color_dict[upper[2]] + '.png'))
    ...
    v0_upper3_image = ImageTk.PhotoImage(Image.open(os.getcwd() + '/Assets/Display_Images/v0_' + 'upper3_' + color_dict[upper[3]] + '.png'))
    ...
    # Cube Front Face
    v0_front0_image = ImageTk.PhotoImage(Image.open(os.getcwd() + '/Assets/Display_Images/v0_' + 'front0_' + color_dict[front[0]] + '.png'))
    ...
    v0_front1_image = ImageTk.PhotoImage(Image.open(os.getcwd() + '/Assets/Display_Images/v0_' + 'front1_' + color_dict[front[1]] + '.png'))
    ...
    v0_front2_image = ImageTk.PhotoImage(Image.open(os.getcwd() + '/Assets/Display_Images/v0_' + 'front2_' + color_dict[front[2]] + '.png'))
    ...
    v0_front3_image = ImageTk.PhotoImage(Image.open(os.getcwd() + '/Assets/Display_Images/v0_' + 'front3_' + color_dict[front[3]] + '.png'))
    ...
    # # Cube Right Face
    v0_right0_image = ImageTk.PhotoImage(Image.open(os.getcwd() + '/Assets/Display_Images/v0_' + 'right0_' + color_dict[right[0]] + '.png'))
    ...
    v0_right1_image = ImageTk.PhotoImage(Image.open(os.getcwd() + '/Assets/Display_Images/v0_' + 'right1_' + color_dict[right[1]] + '.png'))
    ...
    v0_right2_image = ImageTk.PhotoImage(Image.open(os.getcwd() + '/Assets/Display_Images/v0_' + 'right2_' + color_dict[right[2]] + '.png'))
    ...
    v0_right3_image = ImageTk.PhotoImage(Image.open(os.getcwd() + '/Assets/Display_Images/v0_' + 'right3_' + color_dict[right[3]] + '.png'))
